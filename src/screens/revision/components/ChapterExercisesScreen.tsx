...
const ChapterExercisesScreen = () => {
    ...
    const handleSubmitOrContinue = useCallback(() => {
        ...
        if (isLastQuestion) {
            console.log('Exercise complete. Final score:', isCorrect ? score + 1 : score);
    ...
    }, [chapterExerciseId, currentQuestion, isLastQuestion, score, selectedAnswer, sqlAnswers, t, totalQuestions]);
